...
class Generator:
    def __init__(self, nutrition_input, ingredients_include=[], ingredients_exclude=[], params={'n_neighbors': 5, 'return_distance': False}):
        self.nutrition_input = nutrition_input
        self.ingredients_include = ingredients_include
        self.ingredients_exclude = ingredients_exclude
        self.params = params

    def set_request(self, nutrition_input, ingredients_include, ingredients_exclude, params):
        self.nutrition_input = nutrition_input
        self.ingredients_include = ingredients_include
        self.ingredients_exclude = ingredients_exclude
        self.params = params
